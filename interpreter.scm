...
(define commands
  '((00 ,reset)
    (01 ,(lambda () (set! mode prev-mode)))    ; Continue from previous file
    (02 ,(lambda () (update-mode 'print-str))) ; Print string to console
    (03 ,(lambda () (update-mode 'print-var))) ; Print variable value to console
    (04 ,(lambda () (update-mode 'set-var)))   ; Create a variable
    (05 ,(lambda () (update-mode 'mod-var))))) ; Modify a variable

; Establish state tracking for manipulating variables.
...
(define mod-var-steps
  '((00 ,(lambda (val)
    ...
    (03 ,(lambda (val)
      ...
      ; size of the item they're wanting to use
      (cond
        [mod-with-other-var
      ...
      (cond
        ...
        [else
          ...
          (cond
            ...
            [(equal? mode 'mod-var)
             ((eval (cadadr (assoc mod-var-step mod-var-steps))) cmd)]
